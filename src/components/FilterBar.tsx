...
import { FilterOptions, REGIONS, SUPPORT_TYPES } from "../types";
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none pl-4 pr-10 py-3 rounded-xl border border-gray-200 bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none transition-all cursor-pointer"
            >
              {REGIONS.map((region) => (
          ...
          {/* Filter Button */}
          <button className="flex items-center gap-2 px-4 py-3 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 transition-colors">
